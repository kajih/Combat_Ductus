...
- [x] Verified by manual playtest against the live server (not unit tests alone) - Punch should feel like today's Kick pace, Kick should feel noticeably slower than that - played against the live server in the browser client and confirmed to read correctly
